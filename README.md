...
I built this miner entirely with MS Copilot AI — mostly because I'm lazy. I'm not using any paid tokens to support it yet, just the free version tied to my Microsoft account.
...
The entire script was written by AI. I only tweaked a few things, because pure AI output tends to break over time — it forgets context and slowly dismantles working code.
